	...
	<head>
		...
		<meta itemprop="image" content="http://kovrochist43.ru/img/logo.png">
		...
		<meta property="og:image" content="/kovrochist/img/logo.png">
        ...
        {{-- favicon --}}
		<link rel="apple-touch-icon" sizes="180x180" href="/kovrochist/img/favicon/apple-touch-icon.png">
	    <link rel="icon" type="image/png" sizes="32x32" href="/kovrochist/img/favicon/favicon-32x32.png">
	    <link rel="icon" type="image/png" sizes="16x16" href="/kovrochist/img/favicon/favicon-16x16.png">
	    <link rel="manifest" href="/kovrochist/img/favicon/site.webmanifest">
	    <link rel="mask-icon" href="/kovrochist/img/favicon/safari-pinned-tab.svg" color="#5bbad5">
	    <link rel="shortcut icon" href="/kovrochist/img/favicon/favicon.ico" type="image/x-icon">
	    <meta name="msapplication-TileColor" content="#00aba9">
	    <meta name="msapplication-config" content="/kovrochist/img/favicon/browserconfig.xml">
	    <meta name="theme-color" content="#ffffff">

		<meta property="og:type" content="place">
		<meta property="og:title" content="Вятский коврочист - Чистка ковров и ковровых покрытий">
		<meta property="og:url" content="https://kovrochist43.ru">
		<meta property="og:image" content="/kovrochist/img/logo.png">
		...
		<body>
			...
			<div id="app">
				<x-kovrochist.navbar></x-kovrochist.navbar>
				@yield('content')
				<x-kovrochist.footer></x-kovrochist.footer>
			</div>
